...
const slides = [
  {
    ...
    imageMobile: asset("/images/promo/promo-mobile-slide-1.jpg"),
    imageTablet: asset("/images/promo/promo-tablet-slide-1.png"),
    imageDesktop: asset("/images/promo/promo-desktop-slide-1.jpg"),
  },
  {
    id: 2,
    badge: "Осталось всего 10 авто!",
