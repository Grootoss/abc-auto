...
function Order() {
  ...
  const [loanAmount, setLoanAmount] = useState(1100);
  const [term, setTerm] = useState(36);
  const [downPayment, setDownPayment] = useState("50 000");
      ...
      <div className={styles.card}>
          ...
          <div className={styles.split}>
            ...
            <div className={styles.splitCols}>
              <div className={styles.splitCol}>
                <span className={styles.pillRed}>50 000</span>
                <span className={styles.splitLabel}>Первоначальный взнос</span>
              </div>
              <div className={styles.splitCol}>
                <span className={styles.pillGray}>50 000</span>
        ...
        <div className={styles.sliderBlock}>
          <div className={styles.sliderHead}>
            ...
            <strong>0 - {formatLoan(loanAmount)}</strong>
          </div>
